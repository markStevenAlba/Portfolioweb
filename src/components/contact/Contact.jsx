        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <a href="mailto:examplemail.com.com"className="contact__button">Write Me<i
          ...
          <div className="contact__card">
              ...
              <a href="https//api.whatsaap.com/send?
              phone=62214408789&text=Hello, more information!" className="contact__button">Write me<i
              className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
        </div>
